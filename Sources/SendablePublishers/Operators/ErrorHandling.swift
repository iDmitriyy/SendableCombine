...
extension SendableShell {
  ...
  public func `catch`<P: Publisher & Sendable>(
    ...
    return SendableShell<Publishers.Catch<Upstream, P>>(_unverified_SendablePublisher__: caught)
  }
  ...
  public func tryCatch<P: Publisher & Sendable>(
    ...
    return SendableShell<Publishers.TryCatch<Upstream, P>>(_unverified_SendablePublisher__: caught)
  }
  ...
  public func retry(_ retries: Int) -> SendableShell<Publishers.Retry<Upstream>> {
    ...
    return SendableShell<Publishers.Retry<Upstream>>(_unverified_SendablePublisher__: retried)
  }
  ...
  public func replaceError(with output: Output) -> SendableShell<Publishers.ReplaceError<Upstream>> {
    ...
    return SendableShell<Publishers.ReplaceError<Upstream>>(_unverified_SendablePublisher__: replaced)
  }
  ...
  public func replaceEmpty(with output: Output) -> SendableShell<Publishers.ReplaceEmpty<Upstream>> {
    ...
    return SendableShell<Publishers.ReplaceEmpty<Upstream>>(_unverified_SendablePublisher__: replaced)
  }
  ...
  public func assertNoFailure(
    ...
    return SendableShell<Publishers.AssertNoFailure<Upstream>>(_unverified_SendablePublisher__: asserted)
  }
}
...
extension SendableShell where Upstream.Failure == Never {
  ...
  public func setFailureType<E: Error>(to _: E.Type) -> SendableShell<Publishers.SetFailureType<Upstream, E>> {
    ...
    return SendableShell<Publishers.SetFailureType<Upstream, E>>(_unverified_SendablePublisher__: setFailure)
  }
}
